...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <script src="./assets/js/material-dashboard.min.js?v=3.0.2"></script>
    <form action="stu_profile_edit2.php" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <?php
                ...
                $username=$_SESSION['username'];
                $sql = "SELECT bed_no FROM users WHERE username ='$username' ";
                $result = mysqli_query($conn,$sql);
                if(mysqli_num_rows($result) > 0){
                    $row = mysqli_fetch_assoc($result);
                    $bed_no=$row["bed_no"];
        ...
        <tr>
            ...
            <?php
                ...
                $username=$_SESSION['username'];
                $sql = "SELECT middle_name FROM users WHERE username ='$username' ";
                $result = mysqli_query($conn,$sql);
                if(mysqli_num_rows($result) > 0){
                    $row = mysqli_fetch_assoc($result);
        ...
        <tr>
            ...
            <?php
                ...
                $username=$_SESSION['username'];
                $sql = "SELECT nationality FROM users WHERE username ='$username' ";
                $result = mysqli_query($conn,$sql);
                if(mysqli_num_rows($result) > 0){
                    $row = mysqli_fetch_assoc($result);
        ...
        <tr>
            ...
            <?php
                ...
                $username=$_SESSION['username'];
                $sql = "SELECT college_id FROM users WHERE username ='$username' ";
                $result = mysqli_query($conn,$sql);
                if(mysqli_num_rows($result) > 0){
                    $row = mysqli_fetch_assoc($result);
        ...
        <tr>
            ...
            <?php
                ...
                $username=$_SESSION['username'];
                $sql = "SELECT guardian FROM users WHERE username ='$username' ";
                $result = mysqli_query($conn,$sql);
                if(mysqli_num_rows($result) > 0){
                    $row = mysqli_fetch_assoc($result);
        ...
        <tr>
            ...
            <?php
                ...
                $username=$_SESSION['username'];
                $sql = "SELECT guardian_contact FROM users WHERE username ='$username' ";
                $result = mysqli_query($conn,$sql);
                if(mysqli_num_rows($result) > 0){
                    $row = mysqli_fetch_assoc($result);
